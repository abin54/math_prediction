...
def calculate_balance():
    ...
    print(f"\n  [PHASE 1] THE DEBITS (1972–1999):")
    print("    - 1972 'Seed' Deficit: [-8] (Missing Fire energy)")
    print("    - 1999 'Mirror' Deficit: [-1] (Missing Earth energy)")
    print("    - Total 52-Year Liability: [-9]")
    
    # 2. THE CREDITS (2000-2026)
    # The current sequence requires a "+3" to achieve 'Zonal Neutrality'.
    print(f"\n  [PHASE 2] THE CREDITS (2000–2026):")
    print("    - Mandatory Payment: [+3] (Air energy restoration)")
    print("    - Source Year (1974): Provided 'Credit' for this specific 2026 'Debit'.")
    
    # 3. THE RESET
    # 9 + 3 = 12 / 10 = Remainder 2? No, 8+1 = 9. 9 + 6 = 15 -> 5.
    # Actually, the user says the "Vibrational Math" must balance to zero.
    # 52-year Cycle Zero Point: 3.
